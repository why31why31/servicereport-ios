        ...
        build: (pw.Context context) {
          return [
            pw.Container(
              ...
              decoration: const pw.BoxDecoration(color: PdfColor.fromInt(0xFF0068C9)),
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  pw.Row(
                    children: [
                      pw.Expanded(child: pw.Text("Customer: ${_customerController.text.isEmpty ? '-' : _customerController.text}", style: pw.TextStyle(fontSize: 9.5, fontWeight: pw.FontWeight.bold))),
                      pw.Expanded(child: pw.Text("Date: ${_dateController.text.isEmpty ? '-' : _dateController.text}", style: pw.TextStyle(fontSize: 9.5, fontWeight: pw.FontWeight.bold))),
                    ],
                  ),
            ...
            pw.Text("RECOMMENDED SPARE PARTS", style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 11)),
              ...
              children: List.generate(_partItems.length, (index) {
                ...
                return pw.Container(
                  ...
                  child: pw.Row(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Text("${index + 1}.", style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 10)),
                      pw.SizedBox(width: 8),
                      pw.Expanded(
                        child: pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.start,
                          children: [
                            ...
                            pw.Row(
                              children: [
                                pw.Text("Part No: ${item.partNumberController.text.isEmpty ? '-' : item.partNumberController.text}", style: const pw.TextStyle(fontSize: 9)),
                                pw.SizedBox(width: 15),
                                pw.Text("Qty: ${item.qtyController.text.isEmpty ? '1' : item.qtyController.text}", style: const pw.TextStyle(fontSize: 9)),
                              ],
                            ),
                            if (item.remarkController.text.isNotEmpty) ...[
                              pw.SizedBox(height: 3),
                              pw.Text("Remarks: ${item.remarkController.text}", style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey800)),
                            ],
                          ],
                        ),
                      ),
            ...
            if (_notesController.text.isNotEmpty) ...[
              ...
              pw.Text("ADDITIONAL NOTES", style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 10)),
              pw.SizedBox(height: 4),
              pw.Container(
                width: double.infinity,
                padding: const pw.EdgeInsets.all(8),
                ...
                child: pw.Text(_notesController.text, style: const pw.TextStyle(fontSize: 9)),
              ),
            ],
          ];
        },
